...
<input name="bookname" type="text" placeholder="Enter Book Name" class=" form-controle my-2 rounded border-0">
<input name="authorname" type="text" placeholder="Enter Author Name"class=" form-controle my-2 rounded border-0">
<input name="price" type="text" placeholder="Enter Price" class=" form-controle my-2 rounded border-0">
