...
<h2 class="text-warning justify-content-center">ADD BOOK</h2>

<input name="bookname" type="text" placeholder="Enter Book Name" class=" form-controle my-2 rounded border-0"	data-parsley-length="[6, 50]"	>
<input name="authorname" type="text" placeholder="Enter Author Name"class=" form-controle my-2 rounded border-0"	data-parsley-length="[6, 50]"	>
<input name="price" type="text" placeholder="Enter Price" class=" form-controle my-2 rounded border-0" required data-parsley-type="digits"	>
<input name="img"type="file"
       id="avatar" name="avatar"
       accept="image/png, image/jpeg" class="form-control form-control-sm" required>
<button name="add" class="form-controle my-2 btn btn-warning" type="submite">ADD</button>
